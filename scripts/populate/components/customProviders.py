...
arg_products_provider = DynamicProvider(
    ...
    elements = [
        'iPhone 13 Pro', 'Samsung Galaxy S21', 'Google Pixel 6', 'OnePlus 9 Pro', 
        'Xiaomi Mi 11', 'Sony Xperia 1 III', 'Huawei P40 Pro', 'OnePlus Nord', 
        'Google Pixel 5', 'Samsung Galaxy Note 20 Ultra', 'iPhone 12 Mini', 
        'OnePlus 8T', 'Xiaomi Mi 10T Pro', 'Samsung Galaxy A52', 
        'Google Pixel 4a', 'OnePlus 9', 'iPhone SE (2020)', 
        'Xiaomi Poco X3', 'Sony Xperia 5 II', 'Huawei Mate 40 Pro', 
        'Samsung Galaxy Z Fold 2', 'Google Pixel 4', 'OnePlus 8 Pro', 
        'iPhone 11', 'Xiaomi Redmi Note 10 Pro', 'Samsung Galaxy S20 FE', 
        'Google Pixel 3a', 'OnePlus 8', 'Sony Xperia 10 II', 'Huawei P30 Pro', 
        'Samsung Galaxy A72', 'iPhone XR', 'Xiaomi Mi 10', 'OnePlus 7T Pro', 
        'Google Pixel 3', 'Samsung Galaxy S20 Ultra', 'Sony Xperia 10 Plus', 
        'Huawei Nova 7i', 'Xiaomi Mi 9T Pro', 'OnePlus 7 Pro', 'iPhone X', 
        'Samsung Galaxy S20+', 'Google Pixel 3 XL', 'Sony Xperia 10', 
        'Huawei P20 Pro', 'Xiaomi Mi Note 10', 'OnePlus 7T', 'iPhone 8', 
        'Samsung Galaxy S10e', 'Google Pixel 2', 'Sony Xperia XZ3', 
        'Huawei P40 Lite', 'Xiaomi Mi 9', 'OnePlus 6T', 'iPhone 8 Plus', 
        'Samsung Galaxy S10+', 'Google Pixel 2 XL', 'Sony Xperia XZ2', 
        'Huawei P30 Lite', 'Xiaomi Redmi Note 8 Pro', 'OnePlus 6', 
        'iPhone 7', 'Samsung Galaxy S10', 'Google Pixel', 
        'Sony Xperia XZ1', 'Huawei P20', 'Xiaomi Redmi Note 9', 
        'OnePlus 5T', 'iPhone 7 Plus', 'Samsung Galaxy S9', 
        'Google Pixel XL', 'Sony Xperia XZ', 'Huawei P10', 
        'Xiaomi Redmi Note 7', 'OnePlus 5', 'iPhone 6s', 
        'Samsung Galaxy S9+', 'Google Pixel 3a XL', 
        'Sony Xperia XA2', 'Huawei Mate 20 Pro', 
        'Xiaomi Redmi Note 9S', 'OnePlus 3T', 
        'iPhone 6s Plus', 'Samsung Galaxy Note 9', 
        'Google Pixel 3 XL', 'Sony Xperia XA1', 
        'Huawei Mate 20 Lite', 'Xiaomi Poco F2 Pro', 
        'OnePlus 3', 'iPhone 6', 'Samsung Galaxy Note 8', 
        'Google Pixel 3a', 'Sony Xperia XA1 Ultra', 
        'Huawei Mate 10 Pro', 'Xiaomi Mi A3', 'OnePlus X', 
        'iPhone 6 Plus', 'Samsung Galaxy Note 10', 
        'Google Pixel 2', 'Sony Xperia XA2 Ultra', 
        'Huawei Nova 5T', 'Xiaomi Mi A2', 'OnePlus 2', 
        'iPhone 5s', 'Samsung Galaxy A51', 'Google Pixel 4a', 
        'Sony Xperia L3', 'Huawei P10 Lite', 'Xiaomi Mi 8', 
        'OnePlus One','Nike Air Max 90', 'Adidas Superstar', 
        'Converse Chuck Taylor All Star', 'Vans Old Skool', 
        'Puma Cali', 'Reebok Classic Leather', 'New Balance 990', 
        'Under Armour HOVR Phantom', 'Saucony Jazz Original', 
        'Brooks Ghost 13', 'ASICS Gel-Kayano 27', 
        'Salomon Speedcross 5', 'Hoka One One Clifton 7', 
        'Mizuno Wave Rider 24', 'Fila Disruptor', 
        'Sketchers Go Walk 5', 'Merrell Moab 2', 
        'Columbia Newton Ridge Plus II', 
        'Timberland Earthkeepers', 
        'Dr. Martens 1460', 'Birkenstock Arizona', 
        'Crocs Classic', 'Clarks Desert Boot', 
        'UGG Classic Short', 'Steve Madden Gills', 'Vionic Tide II', 'Birkenstock Gizeh', 
        'Keen Targhee II', 'Ecco Soft 7', 'Teva Hurricane XLT2', 'Sanuk Yoga Sling 2', 
        'Chaco Z/Cloud', 'Toms Alpargata', 'Cole Haan Grand Crosscourt', 'Birkenstock Mayari',
        'UGG Neumel', 'Skechers D\'Lites', 'Converse Chuck 70', 'Vans Sk8-Hi', 'Puma RS-X', 
        'Reebok Club C 85', 'New Balance Fresh Foam 1080v11', 'Under Armour Project Rock 3', 
        'Saucony Kinvara 12', 'Brooks Adrenaline GTS 21', 'ASICS Gel-Nimbus 23', 'Salomon XA Pro 3D V8', 
        'Hoka One One Bondi 7', 'Mizuno Wave Inspire 17', 'Fila Ray Tracer', 'Skechers Ultra Flex', 
        'Merrell Jungle Moc', 'Columbia Redmond V2', 'Timberland PRO Pit Boss', 'Dr. Martens 1461', 
        'Birkenstock Boston', 'Crocs Classic Clog', 'Clarks Wallabee', 'UGG Ansley', 'Steve Madden Ecentrcq', 
        'Vionic Walker', 'Birkenstock Milano', 'Keen Newport H2', 'Ecco Biom Fjuel', 'Teva Original Universal', 
        'Sanuk Beer Cozy 2', 'Chaco Z/Volv', 'Toms Classic', 'Cole Haan Zerogrand', 'Birkenstock Madrid', 
        'UGG Fluff Yeah', 'Skechers Go Run', 'Converse Chuck Taylor All Star High Top', 'Vans Authentic', 
        'Puma Calibrate', 'Reebok Nano X1', 'New Balance Fresh Foam Beacon v3', 'Under Armour Charged Assert 8',
        'Saucony Guide 14', 'Brooks Launch 8', 'ASICS Gel-Cumulus 23', 'Salomon X Ultra 3', 'Hoka One One Mach 4', 
        'Mizuno Wave Horizon 5', 'Fila Disruptor II', 'Sketchers D\'Lites 3', 'Merrell Moab 2 Vent', 
        'Columbia Newton Ridge Plus Waterproof Amped', 'Timberland Earthkeepers Rugged', 
        'Dr. Martens 2976 Chelsea Boot', 'Birkenstock Zurich', 'Crocs Bistro', 'Clarks Bushacre 2',
        'UGG Dakota', 'Steve Madden Irenee', 'Vionic Tide', 'Birkenstock Yao', 'Keen Terradora II', 
        'Ecco Soft 8', 'Teva Tirra', 'Sanuk Yoga Mat', 'Chaco Z/2 Classic', 'Toms Avalon', 
        'Cole Haan Original Grand','Samsung QLED Q90T', 'LG OLED C1', 'Sony Bravia XR A90J',
        'TCL 6-Series R635', 'Vizio OLED H1', 'Panasonic HZ2000', 'Philips OLED 805',
        'Hisense U8G', 'Sony Bravia X90J', 'LG NanoCell 90','Samsung RS27T5200SR', 
        'Whirlpool WTW5000DW', 'LG WM4000HBA', 'Frigidaire FFID2426TD', 'GE GNE25JMKES',
        'Electrolux EFLS627UTT', 'Bosch SHPM78W55N', 'KitchenAid KRFC300ESS', 'Maytag MVWB865GC',
        'Amana ABB1924BRM', 'Samsung DV42H5000EW', 'Whirlpool WRS315SNHM', 'LG LFXS28968S',
        'Frigidaire FGHD2368TF', 'GE GTW720BPNDG', 'Electrolux EFME627UTT', 'Bosch SHPM98W75N', 
        'KitchenAid KRMF706ESS', 'Maytag MHW5630HW', 'Amana NED4655EW', 'Samsung DW80R9950US', 
        'Whirlpool WRF555SDHV', 'LG WT7300CW', 'Frigidaire FFSS2615TS', 'GE GFD85ESPNRS', 
        'Electrolux EFLS627UIW', 'Bosch SHPM65W55N', 'KitchenAid KRFF507HPS', 'Maytag MRT118FFFH',
        'Amana NTW4516FW','Jarrón', 'Paraguas', 'Reloj', 'Guitarra', 'Mesa', 'Silla', 'Bufanda', 
        'Taza', 'Cepillo', 'Cámara', 'Espejo', 'Bolso', 'Cuadro', 'Laptop', 'Teléfono', 'Cinturón',
        'Vela', 'Libro', 'Planta', 'Almohada', 'Cepillo de dientes', 'Tenedor', 'Martillo', 'Llave',
